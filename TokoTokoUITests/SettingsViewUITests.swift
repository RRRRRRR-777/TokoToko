...
final class SettingsViewUITests: XCTestCase {
    ...
    func testSettingsViewScrolling() {
        ...
        XCTAssertTrue(app.staticTexts["このアプリについて"].waitForExistence(timeout: 2), "「このアプリについて」が表示されていません")
    ...
    func testSettingsViewBackgroundForegroundTransition() {
        ...
        // 設定画面が表示されていることを確認
        XCTAssertTrue(app.navigationBars["設定"].waitForExistence(timeout: 5), "バックグラウンドから復帰後、設定画面のナビゲーションバーが表示されていません")
    }
