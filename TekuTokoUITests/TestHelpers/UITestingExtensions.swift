...
public enum UITestingExtensions {
  ...
  public struct LaunchOptions {
    ...
    public init(
      isUITesting: Bool = true, isLoggedIn: Bool = false, useDeepLink: Bool = false,
      destination: String? = nil, resetOnboarding: Bool = false, showOnboarding: Bool = false
    ) {
  ...
  ///   - isLoggedIn: ログイン状態
  public static func launchAppWithDeepLink(
    _ app: XCUIApplication, destination: String, isLoggedIn: Bool = true
  ) {
    launchApp(
      app,
