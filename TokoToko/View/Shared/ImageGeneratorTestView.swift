...
struct TestWalkFactory {
    ...
    static func createShortWalk() -> Walk {
        ...
        let locations: [CLLocation] = [
            ...
            CLLocation(latitude: baseLocation.latitude + 0.001, longitude: baseLocation.longitude + 0.001),
            CLLocation(latitude: baseLocation.latitude + 0.002, longitude: baseLocation.longitude + 0.001),
            CLLocation(latitude: baseLocation.latitude + 0.002, longitude: baseLocation.longitude + 0.002),
